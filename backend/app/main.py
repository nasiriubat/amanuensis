...
from .routers import auth, interview, jobs, kinds, papers, profiles, projects, providers, usage, users
...
for r in (auth, users, providers, profiles, projects, papers, interview, kinds, usage, jobs):
